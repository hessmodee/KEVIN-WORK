...
| **Our scratch skills** | zero join regression | coach stubs only |
...
| P1 | Auth/join compat note | KEVIN_MC_STACK_JOIN_COMPAT_OK |
...
Never hessmodee; no PvP Matt; no grief; no Chat/Reader kill; no purchases.
