#!/usr/bin/env python3
"""Kevin deterministic work-admission and priority selector v1.1.
...
v1.1 closes the request-ID/iteration reset loophole: a semantic failure family is
...
def selftest() -> None:
    ...
    print("KEVIN WORK SELECTOR v1.1 SELFTEST PASS semantic_failure_families=true rename_reset=false request_id_reset=false iteration_reset=false read_only_diagnosis=true")
