...
function Validate-Order($o){
    ...
    $verbs=@('dispatch_mission','run_reconcile','run_benchmark','run_support_bridge','refresh_autonomy_telemetry','run_typed_maintenance')
...
function Invoke-SelfTest {
    ...
    Write-Host 'KEVIN WORK ORDER INTAKE v1.2 SELFTEST PASS verbs=6 maintenance_target=fixed winps51_argv=true arbitrary_shell=false caller_argv=false'
}
