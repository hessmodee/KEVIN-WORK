...
$Patched=Join-Path $env:TEMP 'KEVIN-AUTONOMY-ACTUATOR-v0.1b.patched.ps1'
...
$text=$text.Replace($WrongBridge,$CorrectBridge).Replace($OldDesiredPin,$NewDesiredPin)
...
Write-Host "PASS  Applied exactly two deterministic corrections." -ForegroundColor Green
