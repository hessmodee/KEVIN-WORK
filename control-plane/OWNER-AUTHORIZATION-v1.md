...
Status: owner-approved for local installation by the Kevin Autonomy Actuator bootstrap. This document grants only the bounded authority described below and does not permit Kevin to widen it.
